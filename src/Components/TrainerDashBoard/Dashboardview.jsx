        ...
        <div style={{userSelect:"none"}}>
            <div className='flex items-center justify-between
             h-[70px] shadow-lg px-[25px] ' >
              ...
              <div className='flex items-center rounded-[5px]'>
              <img src={lms1} alt="lms1" className="absolute w-24 h-18 top-0 right-20" />
              <h1 className='text-black  leading-[24px] font-extrabold cursor-pointer text-2xl'>Welcome {auth.username}  </h1>
                </div>
                    ...
                    <div className='flex items-center gap-[15px] relative'>
                        ...
                        {openDropdown && (
                            <div className='bg-white border h-[120px] w-[150px] absolute bottom-[-135px] z-20 right-0 pt-[15px] pl-[15px] space-y-[10px]'>
                                ...
                                <p className='cursor-pointer hover:text-[blue] font-semibold'><Link to="/change-password">Change Password</Link></p>
